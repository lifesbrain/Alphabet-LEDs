...
class Sim868:
    def __init__(self):
        ...
        def http_get():
            ...
            send_at('AT+HTTPPARA=\"URL\",\"'+self.http_get_server[0]+self.http_get_server[1]+'\"', 'OK')
        ...
        def http_post():
            send_at('AT+HTTPINIT', 'OK')
            send_at('AT+HTTPPARA=\"CID\",1', 'OK')
            send_at('AT+HTTPPARA=\"URL\",\"'+self.http_post_server[0]+self.http_post_server[1]+'\"', 'OK')
            send_at('AT+HTTPPARA=\"CONTENT\",\"' + self.http_content_type + '\"', 'OK')
